...
export class ClassService {
  ...
  getAllClasses()
    ...
    getClasseByLabel(){
        return this.http.get<Classe[]>(`${this.API_URL}/getClasseByLabel`)
      }

      getClasseByDesc(){
        return this.http.get<Classe[]>(`${this.API_URL}/getClasseDesc`)
      } 


      SearchClasseByLabel(label: string): Observable<Classe[]> {
        return this.http.get<Classe[]>(`${this.API_URL}/rechercheClasse/${label}`)
      }
