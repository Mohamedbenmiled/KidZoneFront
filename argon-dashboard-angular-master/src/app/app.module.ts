...
import { CategoriepostListComponent } from './categoriepost-list/categoriepost-list.component';
import { CategoriepostAddComponent } from './categoriepost-add/categoriepost-add.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CategoriepostListComponent,
    CategoriepostAddComponent,
